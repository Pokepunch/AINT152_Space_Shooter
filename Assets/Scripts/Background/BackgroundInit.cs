...
public class BackgroundInit : MonoBehaviour
{
    ...
    void Start()
    {
        GameObject bg_layer0_1 = Instantiate(bg_layer0, new Vector3(.0f, .0f, .0f), new Quaternion(.0f, .0f, .0f, .0f));
        ...
        GameObject bg_layer1_1 = Instantiate(bg_layer1, new Vector3(.0f, .0f, .0f), new Quaternion(.0f, .0f, .0f, .0f));
